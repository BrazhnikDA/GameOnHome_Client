...
namespace GameOnHome_WINFORM
{
    public partial class ListGames : Form
    {
        ...
        private void pictureBox_tic_tac_MouseEnter(object sender, EventArgs e) {
            ...
            g.DrawRectangle(new Pen(Color.FromArgb(100, Color.MediumVioletRed), 3), 37, 37, 134, 134);   //Создание пера и отрисовка прямоугольника
        ...
        private void pictureBox_shaski_MouseEnter(object sender, EventArgs e) {
            g = pictureBox_back.CreateGraphics();                                                        //Инициализация графики для заднего PictureBox
            g.DrawRectangle(new Pen(Color.FromArgb(100, Color.MediumVioletRed), 3), 205, 37, 134, 134);  //Создание пера и отрисовка прямоугольника
        ...
        private void pictureBox_Three_Row_MouseEnter(object sender, EventArgs e) {
            g = pictureBox_back.CreateGraphics();                                                        //Инициализация графики для заднего PictureBox
            g.DrawRectangle(new Pen(Color.FromArgb(100, Color.MediumVioletRed), 3), 373, 37, 134, 134);  //Создание пера и отрисовка прямоугольника
        ...
        private void pictureBox_saper_MouseEnter(object sender, EventArgs e) {
            g = pictureBox_back.CreateGraphics();                                                        //Инициализация графики для заднего PictureBox
            g.DrawRectangle(new Pen(Color.FromArgb(100, Color.MediumVioletRed), 3), 541, 37, 134, 134);  //Создание пера и отрисовка прямоугольника
        ...
        private void pictureBox_chess_MouseEnter(object sender, EventArgs e) {
            g = pictureBox_back.CreateGraphics();                                                        //Инициализация графики для заднего PictureBox
            g.DrawRectangle(new Pen(Color.FromArgb(100, Color.MediumVioletRed), 3), 709, 37, 134, 134);  //Создание пера и отрисовка прямоугольника
